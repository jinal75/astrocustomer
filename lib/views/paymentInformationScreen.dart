...
class PaymentInformationScreen extends StatelessWidget {
  final double amount;
  final int? flag;
  PaymentInformationScreen({Key? key, required this.amount, this.flag}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('GST ${global.getSystemFlagValue(global.systemFlagNameList.gst)}%').translate(),
                            Expanded(
                              child: Align(
